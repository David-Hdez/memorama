document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkCoincide() {
        ...
        if (tarjetasElegidas[0] == tarjetasElegidas[1]) {
            ...
            tarjetas[opcionUnoId].addEventListener('click', voltearTarjeta);
            tarjetas[opcionDosId].addEventListener('click', voltearTarjeta);
        }
        ...
        if (tarjetasGanadas.length == tarjetasJuego.length / 2) {
    ...
    function voltearTarjeta() {
        ...
        this.removeEventListener('click', voltearTarjeta);//No volver a elegir la tarjeta
